...
def get_album_tracks(client: Spotify, album: SpotifyAlbum) -> List[SpotifyTrack]:
...
def get_uris(tracks: List[SpotifyTrack]) -> List[str]:
...
def get_all_releases(client: Spotify, label: str) -> List[SpotifyAlbum]:
    releases = []
